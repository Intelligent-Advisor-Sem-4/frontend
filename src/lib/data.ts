...
import {StockData, PredictionData, ModelMetadataType} from './types/stock_prediction';
...
export function getStockData(ticker: string, startDate: Date, endDate: Date): StockData {
...
export function getPredictionData(ticker: string, lastDate: Date): PredictionData {
...
// Get model metadata
export function getModelMetadata(ticker: string): ModelMetadataType {
